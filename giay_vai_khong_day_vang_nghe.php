...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>giày vải không dây vàng nghệ | MỘT</title>
            ...
            <div class="header">
                ...
                <div class="header__header-2">
                    ...
                    <div class="header-2__slides">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_vang_nghe/1500x1000_DT_vang-nghe_profile.webp" alt="" class="slides__slide show">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_vang_nghe/1500x1000_DT_vang-nghe_onfeet_HAU.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_vang_nghe/1500x1000_DT_vang-nghe_onfeet_ninja.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_vang_nghe/1500x1000_DT_vang-nghe_top.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_vang_nghe/1500x1000_DT_vang-nghe_sole.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_vang_nghe/1500x1000_DT_vang-nghe_rear.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_vang_nghe/1500x1000_DT_vang-nghe_front.webp" alt="" class="slides__slide">
                    </div>
            ...
            <div class="body">
                <div class="body__product-details">
                    <div class="product-details__content-product">
                        <h1 class="content-product__name-product">giày vải không dây Vàng nghệ</h1>
                        <p class="content-product__price-product"><b>720,000 VND</b></p>
                        <p>
                            bạn có biết <b>“nghệ”</b> – 藝 có nghĩa Hán Việt là “tài năng”? nhưng sau nhiều trăm năm, hiện nay “nghệ” đã phái sinh ra nhiều nét nghĩa mới, trong đó có Một nét nghĩa là “làm điều mình giỏi, giỏi điều mình làm.”
                        </p>
                        <p>
                        ...
                        <p>____</p>
                        <p>
                            giày vải Đời-thường <b>không dây</b> được làm bằng vải bố 100% cô-tông,
                        ...
                        <div class="product-details__buttons-share">
                            Chia sẻ đến: 
                            <a href="http://www.facebook.com/sharer/sharer.php?u=shopgiaymot.byethost7.com/giay_vai_khong_day_vang_nghe.php?idgiay=78" class="button-share share facebook"><i class="fa-brands fa-facebook-f icon"></i> Share</a>
                            <a href="https://twitter.com/intent/tweet?url=shopgiaymot.byethost7.com/giay_vai_khong_day_vang_nghe.php?idgiay=78" class="button-share share twitter"><i class="fa-brands fa-twitter icon"></i> Tweet</a>
                            <a href="http://www.linkedin.com/shareArticle?mini=true&url=shopgiaymot.byethost7.com/giay_vai_khong_day_vang_nghe.php?idgiay=78" class="button-share share linkedin"><i class="fa-brands fa-linkedin-in icon"></i> LinkedIn</a>
                        </div>
                        <!-- NUT CHIA SẺ - START -->
                    ...
                    <div class="product-details__option-product">
                        ...
                        <div onclick="clickButtonAddCart(<?php echo $id_giay; ?>, 'giay_vai_khong_day_vang_nghe');" class="option-product__button-add-cart inactive">thêm vào giỏ hàng</div>
