...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>giày vải không dây xanh lá cây | MỘT</title>
            ...
            <div class="header">
                ...
                <div class="header__header-2">
                    ...
                    <div class="header-2__slides">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_xanh_la_cay/1500x1000_xanh-la-cay_doi-thuong_profile.webp" alt="" class="slides__slide show">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_xanh_la_cay/scroll_xanh-la-cay_doi-thuong_3x2.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_xanh_la_cay/1500x1000_xanh-la-cay_doi-thuong_top.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_xanh_la_cay/1500x1000_DT_da-xam-nhat_sole.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_xanh_la_cay/1500x1000_xanh-la-cay_doi-thuong_rear.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_xanh_la_cay/1500x1000_xanh-la-cay_doi-thuong_front.webp" alt="" class="slides__slide">
                    </div>
            ...
            <div class="body">
                <div class="body__product-details">
                    <div class="product-details__content-product">
                        <h1 class="content-product__name-product">giày vải không dây Xanh lá cây</h1>
                        <p class="content-product__price-product"><b>720,000 VND</b></p>
                        <p>
                            Một làm giày màu <b>xanh lá cây</b> quen thuộc của màu rừng nước mình : êm chân mà còn mát mắt !
                            làm liền Một đôi để tinh thần tốt tươi như lá, cả ngày !
                        </p>
                        <p>____</p>
                        <p>
                            giày vải Đời-thường <b>không dây</b> được làm bằng vải bố 100% cô-tông<br>
                        ...
                        <div class="product-details__buttons-share">
                            Chia sẻ đến: 
                            <a href="http://www.facebook.com/sharer/sharer.php?u=shopgiaymot.byethost7.com/giay_vai_khong_day_xanh_la_cay.php?idgiay=80" class="button-share share facebook"><i class="fa-brands fa-facebook-f icon"></i> Share</a>
                            <a href="https://twitter.com/intent/tweet?url=shopgiaymot.byethost7.com/giay_vai_khong_day_xanh_la_cay.php?idgiay=80" class="button-share share twitter"><i class="fa-brands fa-twitter icon"></i> Tweet</a>
                            <a href="http://www.linkedin.com/shareArticle?mini=true&url=shopgiaymot.byethost7.com/giay_vai_khong_day_xanh_la_cay.php?idgiay=80" class="button-share share linkedin"><i class="fa-brands fa-linkedin-in icon"></i> LinkedIn</a>
                        </div>
                        <!-- NUT CHIA SẺ - START -->
                    ...
                    <div class="product-details__option-product">
                        <div class="option-product__colors">
                            ...
                            <div class="colors__list-color">
                                ...
                                <div onclick="clickLink(15);" class="colors__color-outside checked">
                        ...
                        <div onclick="clickButtonAddCart(<?php echo $id_giay; ?>, 'giay_vai_khong_day_xanh_la_cay');" class="option-product__button-add-cart inactive">thêm vào giỏ hàng</div>
