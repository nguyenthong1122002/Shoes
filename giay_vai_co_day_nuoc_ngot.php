...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>giày vải có dây nước ngọt | MỘT</title>
            ...
            <div class="header">
                ...
                <div class="header__header-2">
                    ...
                    <div class="header-2__slides">
                        <img src="./images/images_san-pham/giay_vai_co_day/mau_nuoc_ngot/1500x1000_dm_nuoc-ngot_profile.webp" alt="" class="slides__slide show">
                        <img src="./images/images_san-pham/giay_vai_co_day/mau_nuoc_ngot/1500x1000_dm_nuoc-ngot_front.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_co_day/mau_nuoc_ngot/1500x1000_dm_nuoc-ngot_rear.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_co_day/mau_nuoc_ngot/1500x1000_dm_nuoc-ngot_sole.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_co_day/mau_nuoc_ngot/1500x1000_dm_nuoc-ngot_top.webp" alt="" class="slides__slide">
                    </div>
            ...
            <div class="body">
                <div class="body__product-details">
                    <div class="product-details__content-product">
                        <h1 class="content-product__name-product">giày vải có dây Nước ngọt</h1>
                        ...
                        <div class="product-details__buttons-share">
                            Chia sẻ đến: 
                            <a href="http://www.facebook.com/sharer/sharer.php?u=shopgiaymot.byethost7.com/giay_vai_co_day_nuoc_ngot.php?idgiay=67" class="button-share share facebook"><i class="fa-brands fa-facebook-f icon"></i> Share</a>
                            <a href="https://twitter.com/intent/tweet?url=shopgiaymot.byethost7.com/giay_vai_co_day_nuoc_ngot.php?idgiay=67" class="button-share share twitter"><i class="fa-brands fa-twitter icon"></i> Tweet</a>
                            <a href="http://www.linkedin.com/shareArticle?mini=true&url=shopgiaymot.byethost7.com/giay_vai_co_day_nuoc_ngot.php?idgiay=67" class="button-share share linkedin"><i class="fa-brands fa-linkedin-in icon"></i> LinkedIn</a>
                        </div>
                        <!-- NUT CHIA SẺ - START -->
                    ...
                    <div class="product-details__option-product">
                        <div class="option-product__colors">
                            ...
                            <div class="colors__list-color">
                                <div onclick="clickLink(2);" class="colors__color-outside checked">
                        ...
                        <div onclick="clickButtonAddCart(<?php echo $id_giay; ?>, 'giay_vai_co_day_nuoc_ngot');" class="option-product__button-add-cart inactive">thêm vào giỏ hàng</div>
