...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>da có dây xám nhẹ | MỘT</title>
            ...
            <div class="header">
                ...
                <div class="header__header-2">
                    ...
                    <div class="header-2__slides">
                        <img src="./images/images_san-pham/giay_da_co_day/mau_xam_nhe/1500x1000_DM_da-xam-nhat_profile.webp" alt="" class="slides__slide show">
                        <img src="./images/images_san-pham/giay_da_co_day/mau_xam_nhe/1500x1000_DM_da-xam-nhat_front.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_da_co_day/mau_xam_nhe/1500x1000_DM_da-xam-nhat_rear.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_da_co_day/mau_xam_nhe/1500x1000_DM_da-xam-nhat_sole.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_da_co_day/mau_xam_nhe/1500x1000_DM_da-xam-nhat_top.webp" alt="" class="slides__slide">
                    </div>
            ...
            <div class="body">
                <div class="body__product-details">
                    <div class="product-details__content-product">
                        <h1 class="content-product__name-product">giày da có dây Xám nhẹ</h1>
                        ...
                        <div class="product-details__buttons-share">
                            Chia sẻ đến: 
                            <a href="http://www.facebook.com/sharer/sharer.php?u=shopgiaymot.byethost7.com/giay_da_co_day_xam_nhe.php?idgiay=66" class="button-share share facebook"><i class="fa-brands fa-facebook-f icon"></i> Share</a>
                            <a href="https://twitter.com/intent/tweet?url=shopgiaymot.byethost7.com/giay_da_co_day_xam_nhe.php?idgiay=66" class="button-share share twitter"><i class="fa-brands fa-twitter icon"></i> Tweet</a>
                            <a href="http://www.linkedin.com/shareArticle?mini=true&url=shopgiaymot.byethost7.com/giay_da_co_day_xam_nhe.php?idgiay=66" class="button-share share linkedin"><i class="fa-brands fa-linkedin-in icon"></i> LinkedIn</a>
                        </div>
                        <!-- NUT CHIA SẺ - START -->
                    ...
                    <div class="product-details__option-product">
                        <div class="option-product__colors">
                            ...
                            <div class="colors__list-color">
                                <div onclick="clickLink(0);" class="colors__color-outside">
                                    <div class="color-outside__color" style="background-color: var(--mau-den-tuyen);"></div>
                                </div>
                                <div onclick="clickLink(1);" class="colors__color-outside checked">
                        ...
                        <div onclick="clickButtonAddCart(<?php echo $id_giay; ?>, 'giay_da_co_day_xam_nhe');" class="option-product__button-add-cart inactive">thêm vào giỏ hàng</div>
