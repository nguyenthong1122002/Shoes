...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>giày vải không dây quá đỏ | MỘT</title>
            ...
            <div class="header">
                ...
                <div class="header__header-2">
                    ...
                    <div class="header-2__slides">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_qua_do/1500x1000_DT_qua-do_profile.webp" alt="" class="slides__slide show">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_qua_do/1500x1000_DT_qua-do_top.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_qua_do/1500x1000_DT_qua-do_sole.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_qua_do/1500x1000_DT_qua-do_rear.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_qua_do/1500x1000_DT_qua-do_front.webp" alt="" class="slides__slide">
                    </div>
            ...
            <div class="body">
                <div class="body__product-details">
                    <div class="product-details__content-product">
                        <h1 class="content-product__name-product">giày vải không dây Quá đỏ</h1>
                        <p class="content-product__price-product"><b>720,000 VND</b></p>
                        <p>
                            Là Một mẫu giày ra mắt đầu tiên và được ưa chuộng
                            Chọn Một <b>quá đỏ</b> cho những lúc bạn cần nhiều vận may !
                        </p>
                        <p>____</p>
                        <p>
                        ...
                        <div class="product-details__buttons-share">
                            Chia sẻ đến: 
                            <a href="http://www.facebook.com/sharer/sharer.php?u=shopgiaymot.byethost7.com/giay_vai_khong_day_qua_do.php?idgiay=76" class="button-share share facebook"><i class="fa-brands fa-facebook-f icon"></i> Share</a>
                            <a href="https://twitter.com/intent/tweet?url=shopgiaymot.byethost7.com/giay_vai_khong_day_qua_do.php?idgiay=76" class="button-share share twitter"><i class="fa-brands fa-twitter icon"></i> Tweet</a>
                            <a href="http://www.linkedin.com/shareArticle?mini=true&url=shopgiaymot.byethost7.com/giay_vai_khong_day_qua_do.php?idgiay=76" class="button-share share linkedin"><i class="fa-brands fa-linkedin-in icon"></i> LinkedIn</a>
                        </div>
                        <!-- NUT CHIA SẺ - START -->
                    ...
                    <div class="product-details__option-product">
                        <div class="option-product__colors">
                            <span class="colors__name-color"><b>quá đỏ</b></span>
                            <div class="colors__list-color">
                                ...
                                <div onclick="clickLink(11);" class="colors__color-outside checked">
                        ...
                        <div onclick="clickButtonAddCart(<?php echo $id_giay; ?>, 'giay_vai_khong_day_qua_do');" class="option-product__button-add-cart inactive">thêm vào giỏ hàng</div>
