...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <title>giày vải không dây nước ngọt | MỘT</title>
            ...
            <div class="header">
                ...
                <div class="header__header-2">
                    ...
                    <div class="header-2__slides">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_nuoc_ngot/1500x1000_dt_nuoc-ngot_profile.webp" alt="" class="slides__slide show">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_nuoc_ngot/1500x1000_dt_nuoc-ngot_top-1.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_nuoc_ngot/1500x1000_dt_nuoc-ngot_sole.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_nuoc_ngot/1500x1000_dt_nuoc-ngot_rear.webp" alt="" class="slides__slide">
                        <img src="./images/images_san-pham/giay_vai_khong_day/mau_nuoc_ngot/1500x1000_dt_nuoc-ngot_front.webp" alt="" class="slides__slide">
                    </div>
            ...
            <div class="body">
                <div class="body__product-details">
                    <div class="product-details__content-product">
                        <h1 class="content-product__name-product">giày vải không dây Nước ngọt</h1>
                        <p class="content-product__price-product"><b>790,000 VND</b></p>
                        <p>
                            giày Nước ngọt mang màu cát mát mẻ dưới suối – Một tinh thần tự nhiên và lành mạnh cho dịp cuối hè<br>
                            hai dòng Đời-mới có dây và Đời-thường không dây : êm đẹp bất chấp !<br>
                            để bạn mang nhẹ – chơi vui – không lo nghĩ !
                        </p>
                        <p>____</p>
                        <p>
                            với chất liệu cotton bố 100%, Một đôi giày Nước ngọt có màu cát-ánh-xanh kết hợp với đế cao su đúc nguyên khối màu vỏ cây tiếp năng lượng cho Một mùa tận hưởng !
                        </p>

                        <!-- NÚT CHIA SẺ - START -->
                        <div class="product-details__buttons-share">
                            Chia sẻ đến: 
                            <a href="http://www.facebook.com/sharer/sharer.php?u=shopgiaymot.byethost7.com/giay_vai_khong_day_nuoc_ngot.php?idgiay=75" class="button-share share facebook"><i class="fa-brands fa-facebook-f icon"></i> Share</a>
                            <a href="https://twitter.com/intent/tweet?url=shopgiaymot.byethost7.com/giay_vai_khong_day_nuoc_ngot.php?idgiay=75" class="button-share share twitter"><i class="fa-brands fa-twitter icon"></i> Tweet</a>
                            <a href="http://www.linkedin.com/shareArticle?mini=true&url=shopgiaymot.byethost7.com/giay_vai_khong_day_nuoc_ngot.php?idgiay=75" class="button-share share linkedin"><i class="fa-brands fa-linkedin-in icon"></i> LinkedIn</a>
                        </div>
                        <!-- NUT CHIA SẺ - START -->
                    ...
                    <div class="product-details__option-product">
                        <div class="option-product__colors">
                            <span class="colors__name-color"><b>nước ngọt</b></span>
                            <div class="colors__list-color">
                                <div onclick="clickLink(10);" class="colors__color-outside checked">
                                ...
                                <div onclick="clickLink(13);" class="colors__color-outside">
                        ...
                        <div onclick="clickButtonAddCart(<?php echo $id_giay; ?>, 'giay_vai_khong_day_nuoc_ngot');" class="option-product__button-add-cart inactive">thêm vào giỏ hàng</div>
